...
# posterior = posterior_whole[6000:N:20,:]

posterior_whole = np.random.rand(20001,2)
N, D = posterior_whole.shape
posterior = posterior_whole[6000:N:100,:]
...
ax3 = fig.add_subplot(223, xlim=i_width, ylim=s_width,xlabel='$\gamma$',ylabel='a')
ax1.set_xticks([])
ax2.set_xticks([])
ax1.set_yticks([])
ax2.set_yticks([])
...
# ani.save('c:/Liang/Googlebox/Research/Project2/MCMC_test2.mp4', writer=writer)
